...
@pytest.fixture()
def test_config_files_to_stats(test_calculate_credit_averages):
...
def test_add_mag_to_combined_stats(test_config_files_to_stats):
    expected={}
    result={}
